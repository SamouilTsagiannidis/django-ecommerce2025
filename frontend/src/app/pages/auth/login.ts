                ...
                <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                    <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                        ...
                        <div>
                            ...
                            <input pInputText id="username" type="text" placeholder="Username" class="w-full md:w-[30rem] mb-8" [(ngModel)]="user.username" />
                            ...
                            <p-button label="Sign In" styleClass="w-full"(onClick)="UserLogin()" routerLink="/"></p-button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        if (this.user.username && this.user.password) {
            this.authService.login(this.user).subscribe(
                response => {
                    ...
                    // Save the authentication token or user data if necessary
                },
                error => {
